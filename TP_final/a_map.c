...
void a_disp_map(void){
    ...
    al_draw_filled_rectangle(0, ROW_TO_Y(GOALROW), GAME_WIDTH, ROW_TO_Y(STARTLAKE) + ADJCOORDFROG(1), water);
    ...
    if (sidewalk_tile){
        ...
        al_draw_filled_rectangle(0, ROW_TO_Y(SAFEROW), GAME_WIDTH, ROW_TO_Y(SAFEROW) + ADJCOORDFROG(1), strip);
        al_draw_filled_rectangle(0, ROW_TO_Y(0), GAME_WIDTH, ROW_TO_Y(0) + ADJCOORDFROG(1), strip);
